...
class TwitterTweetsPipeline(object):
...
class MongoPipeline(object):
    ...
    def from_crawler(cls, crawler):
        return cls(
            mongo_uri=crawler.settings.get('MONGO_URI', 'mongodb://172.16.20.252:27017'),
...
class Neo4jPipline(object):
    ...
    def __init__(self):
        self.graph = Graph("http://172.16.20.228:7474",username="neo4j",password="123456")
